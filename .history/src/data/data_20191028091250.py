...
class TransformData:
    ...
    """ 
    TransformData takes the raw extracted data cleans and creates new features.
    
    Only one passenger with title Lady. She was traveling with a sibling and no husband. 
    Set title to Miss
