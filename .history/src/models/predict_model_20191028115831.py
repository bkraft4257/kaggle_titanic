...
print(f"\n\n{datetime.datetime.now().strftime('%Y-%m-%d')}, <model>, {scores['test_accuracy'].mean():0.4f}, {scores['test_recall'].mean():0.4f},{scores['test_precision'].mean():0.4f},{scores['test_f1'].mean():0.4f}, NS" )